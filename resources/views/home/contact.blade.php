...
<div class="fluied_container">
    ...
    <div class="row">
        <div class="col-xs-12" style="padding-left:0px;padding-right:0px;">
            <div class="cover-img" style="background-image: url({{ $contacts->background_url }});"
                 data-aos="zoom-in">
        ...
        <div class="row row-contactus">
            <div class="col-sm-8 col-xs-12">
                ...
                <div class="col-sm-6 col-xs-12 col-contactus">
                    ...
                    <div class="col-xs-8">
                        <h4>scedule</h4>
                        <h5>{{ $contacts->ftime ?? ''}} to {{ $contacts->ltime ?? ''}}</h5>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <form action="/message" method="post" enctype="multipart/form-data" class="form-contact-page">
                    @csrf
                    ...
                    <div class="input-group inputs-in-contactus-page">
                        <div class="form-group label-floating">
                                <textarea name="message" type="text" rows="3" class="form-control input-register"
