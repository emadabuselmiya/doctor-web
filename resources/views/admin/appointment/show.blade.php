                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('age') is-invalid @enderror" disabled
                                   name="age"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('gender') is-invalid @enderror" name="gender" id="gender"
                                ...
                                @foreach ($genders as $item)
                                    <option value="{{ $item }}"
                                            @if($item == old('parent_id', $appointment->gender)) selected @endif>{{ $item }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" disabled
                                   name="email"
