...
<div class="row">
    <div class="col-md-6 p-3">
        ...
        <img id="output_logo" src="{{ $contact->logo_url }} " alt="" height="200"
             class="d-block m-3">
        <input type="file" class="form-control @error('logo') is-invalid @enderror" onchange="loadFile_logo(logo)"
               name="logo">
    ...
    <div class="col-md-6 p-3">
        ...
        <img id="output_background" src="{{ $contact->background_url }}" alt=""
             height="200"
             width="700"
             class="d-block m-3">
        <input type="file" class="form-control @error('image') is-invalid @enderror"
               onchange="loadFile_background(background)" name="background">
